...
class Variables {
  ...
  double _sampleFrequency = 0.0; // frequency;
  double _qW = 0.0; // data quaternion
  double _qX = 0.0; // data quaternion
  double _qY = 0.0; // data quaternion
  double _qZ = 0.0; // data quaternion
  double _integralFbX = 0.0; // apply integral feedback
  double _integralFbY = 0.0; // apply integral feedback
  double _integralFbZ = 0.0; // apply integral feedback
  double _ki = 0.0; // 2 * integral gain (Ki), (2.0 * 0.0) = 0.0
  double _kp = 1.0; // 2 * proportional gain (Kp), (2.0 * 0.5) = 1.0
